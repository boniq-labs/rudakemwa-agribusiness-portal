...
export const stockAPI = {
  ...
  issue: (data: any) => api.post('/stock/transactions/issue', data),
  transfer: (data: any) => api.post('/stock/transactions/transfer', data),
  adjust: (data: any) => api.post('/stock/transactions/adjust', data),
...
export const procurementAPI = {
  ...
  receiveGoods: (id: number, data: any) => api.put(`/procurement/orders/${id}/receive`, data),
...
export const logisticsAPI = {
  ...
  reject: (id: number, reason?: string) => api.put(`/logistics/requests/${id}/reject`, { reason }),
...
export const salesAPI = {
  ...
  getReturns: (params?: any) => api.get('/sales/returns', { params }),
