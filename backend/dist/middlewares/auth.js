...
const isSuperAdmin = (role) => role === 'owner' || role === 'farm_owner' || role === 'admin';
export const authenticate = async (req, res, next) => {
    ...
    try {
        ...
        const [rows] = await pool.query(`SELECT u.id, u.username, r.slug as role, u.role_id, u.department_id,
